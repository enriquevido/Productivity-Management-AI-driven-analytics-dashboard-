...
PAGES = {
    "Overview":  "pages/2_Overview_Dashboard.py",
    "Employees": "pages/3_Employee_Performance.py",
    "Benchmark": "pages/4_Benchmark_Global.py",
    "AI Learning": "pages/5_AI_Learning_and_Explainability.py",
}
...
def top_nav(
    ...
    with right:
        ...
        selected = option_menu(
            None,
            labels,
            icons=["bar-chart", "people", "globe", "cpu"],
